...
var divSideNav = document.getElementsByClassName("dropdown-content")[0];
var btnSideNav = document.getElementsByClassName("dropdown-toggle")[0];
...
btnSideNav.addEventListener('click', function(event) {
	divSideNav.classList.toggle("show");
});
...
window.onclick = function(event) {
	...
	((!climbUpDOM(event.target, ".dropdown-content") && !climbUpDOM(event.target, ".dropdown-toggle")))) {
		...
		divSideNav.classList.remove("show");
	}
}
