...
<div class="row" style="background-color: #cce;">
	...
	<div class="col-md-3">
		<form action='' method='POST' id='utilized' class="form-inline">
			...
			<button type='submit' name='time' value = 'specific' class='btn btn-col btn-block'>W określonym poniżej zakresie</button>
			<div align="center">
				<br><label for="utd-f"> OD: </label> <input type="date" class="form-control" name="utilized_from" id="utd-f" required><br>
...
<div class="row top-buffer" style="background-color: #cce">
	...
	<div class="col-md-3">
		<form action='' method='POST' id='to_utilize' class="form-inline">
			...
			<button type='submit' name='time_to' value = 'specific' class='btn btn-col btn-block'>W określonej przyszłości</button>
			<div align="center">
				<br><label for="tout-f"> OD: </label> <input type="date" class="form-control" name="to_utilize_from" id="tout-f" required><br>
